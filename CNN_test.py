...
model = Sequential()
model.add(Conv1D(32,(3,),activation='relu',padding='same',input_shape=(timesteps, data_dim)))
...
ax[0][0].legend(['CNN预测走势','实际走势'],loc='upper left',prop=font)
...
ax[0][1].legend(['CNN预测走势','实际走势'],loc='upper left',prop=font)
...
ax[1][0].legend(['CNN预测走势','实际走势'],loc='upper left',prop=font)
...
ax[1][1].legend(['CNN预测走势','实际走势'],loc='upper left',prop=font)
...
ax[2][0].legend(['CNN预测走势','实际走势'],loc='upper left',prop=font)
...
ax[2][1].legend(['CNN预测走势','实际走势'],loc='upper left',prop=font)
plt.tight_layout()
plt.savefig('cnn_pred.png',dpi=300)
